/* eslint-disable */
import { TransactionId, Transaction } from "./types";
...
export function transactionState_TransactionStateFromJSON(
  object: any
...
export function transactionState_TransactionStateToJSON(
  object: TransactionState_TransactionState
): string {
  switch (object) {
...
export const TransactionsIds = {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): TransactionsIds {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.transactionId.push(
            TransactionId.decode(reader, reader.uint32())
          );
          break;
        default:
  ...
  toJSON(message: TransactionsIds): unknown {
    ...
    if (message.transactionId) {
      obj.transactionId = message.transactionId.map((e) =>
        e ? TransactionId.toJSON(e) : undefined
      );
    } else {
      obj.transactionId = [];
    }
  ...
  fromPartial(object: DeepPartial<TransactionsIds>): TransactionsIds {
    ...
    message.transactionId =
      object.transactionId?.map((e) => TransactionId.fromPartial(e)) || [];
    return message;
  },
};
  ...
  fromJSON(object: any): SubmitTransactionResponse {
    return {
      ...
      txstate: isSet(object.txstate)
        ? TransactionState.fromJSON(object.txstate)
        : undefined,
    };
  },
  ...
  toJSON(message: SubmitTransactionResponse): unknown {
    ...
    message.txstate !== undefined &&
      (obj.txstate = message.txstate
        ? TransactionState.toJSON(message.txstate)
        : undefined);
    return obj;
  },
  ...
  fromPartial(
    ...
    message.status =
      object.status !== undefined && object.status !== null
        ...
        : undefined;
    message.txstate =
      object.txstate !== undefined && object.txstate !== null
...
export const TransactionsStateRequest = {
  ...
  fromPartial(
    object: DeepPartial<TransactionsStateRequest>
  ): TransactionsStateRequest {
    const message = createBaseTransactionsStateRequest();
    message.transactionId =
      object.transactionId?.map((e) => TransactionId.fromPartial(e)) || [];
...
export const TransactionsStateResponse = {
  ...
  decode(
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.transactionsState.push(
            TransactionState.decode(reader, reader.uint32())
          );
          break;
        case 2:
  ...
  toJSON(message: TransactionsStateResponse): unknown {
    ...
    if (message.transactionsState) {
      obj.transactionsState = message.transactionsState.map((e) =>
        e ? TransactionState.toJSON(e) : undefined
      );
    } else {
  ...
  fromPartial(
    object: DeepPartial<TransactionsStateResponse>
  ): TransactionsStateResponse {
    const message = createBaseTransactionsStateResponse();
    message.transactionsState =
      object.transactionsState?.map((e) => TransactionState.fromPartial(e)) ||
      [];
...
export const TransactionsStateStreamRequest = {
  ...
  fromPartial(
    object: DeepPartial<TransactionsStateStreamRequest>
  ): TransactionsStateStreamRequest {
    const message = createBaseTransactionsStateStreamRequest();
    message.transactionId =
      object.transactionId?.map((e) => TransactionId.fromPartial(e)) || [];
...
export const TransactionsStateStreamResponse = {
  ...
  decode(
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.transactionState = TransactionState.decode(
            reader,
            reader.uint32()
          );
          break;
  ...
  fromJSON(object: any): TransactionsStateStreamResponse {
    return {
      transactionState: isSet(object.transactionState)
        ? TransactionState.fromJSON(object.transactionState)
        : undefined,
      transaction: isSet(object.transaction)
  ...
  toJSON(message: TransactionsStateStreamResponse): unknown {
    ...
    message.transactionState !== undefined &&
      (obj.transactionState = message.transactionState
        ? TransactionState.toJSON(message.transactionState)
        : undefined);
    message.transaction !== undefined &&
  ...
  fromPartial(
    object: DeepPartial<TransactionsStateStreamResponse>
  ): TransactionsStateStreamResponse {
    const message = createBaseTransactionsStateStreamResponse();
    message.transactionState =
...
export const TransactionState = {
  ...
  fromJSON(object: any): TransactionState {
    return {
      ...
      state: isSet(object.state)
        ? transactionState_TransactionStateFromJSON(object.state)
        : 0,
    };
  },
  ...
  toJSON(message: TransactionState): unknown {
    ...
    message.state !== undefined &&
      (obj.state = transactionState_TransactionStateToJSON(message.state));
    return obj;
  },
