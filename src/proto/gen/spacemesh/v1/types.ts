...
export const GasOffered = {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): GasOffered {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.gasProvided = longToNumber(reader.uint64() as Long);
          break;
        case 2:
  ...
  fromJSON(object: any): GasOffered {
    return {
      gasProvided: isSet(object.gasProvided) ? Number(object.gasProvided) : 0,
  ...
  toJSON(message: GasOffered): unknown {
    const obj: any = {};
    message.gasProvided !== undefined &&
      (obj.gasProvided = Math.round(message.gasProvided));
    message.gasPrice !== undefined &&
      (obj.gasPrice = Math.round(message.gasPrice));
    return obj;
  },

  fromPartial(object: DeepPartial<GasOffered>): GasOffered {
    const message = createBaseGasOffered();
  ...
  fromJSON(object: any): CoinTransferTransaction {
    return {
      receiver: isSet(object.receiver)
        ? AccountId.fromJSON(object.receiver)
        : undefined,
    };
  },
  ...
  toJSON(message: CoinTransferTransaction): unknown {
    ...
    message.receiver !== undefined &&
      (obj.receiver = message.receiver
        ? AccountId.toJSON(message.receiver)
        : undefined);
    return obj;
  },

  fromPartial(
    object: DeepPartial<CoinTransferTransaction>
  ): CoinTransferTransaction {
    const message = createBaseCoinTransferTransaction();
    message.receiver =
...
export const SmartContractTransaction = {
  ...
  fromJSON(object: any): SmartContractTransaction {
    return {
      type: isSet(object.type)
        ? smartContractTransaction_TransactionTypeFromJSON(object.type)
        : 0,
  ...
  toJSON(message: SmartContractTransaction): unknown {
    ...
    message.type !== undefined &&
      (obj.type = smartContractTransaction_TransactionTypeToJSON(message.type));
  ...
  fromPartial(
    object: DeepPartial<SmartContractTransaction>
  ): SmartContractTransaction {
    const message = createBaseSmartContractTransaction();
...
export const Signature = {
  ...
  fromJSON(object: any): Signature {
    return {
      scheme: isSet(object.scheme)
        ? signature_SchemeFromJSON(object.scheme)
        : 0,
  ...
  toJSON(message: Signature): unknown {
    ...
    message.scheme !== undefined &&
      (obj.scheme = signature_SchemeToJSON(message.scheme));
...
export const Activation = {
  ...
  fromJSON(object: any): Activation {
    return {
      ...
      coinbase: isSet(object.coinbase)
        ...
        : undefined,
      prevAtx: isSet(object.prevAtx)
        ? ActivationId.fromJSON(object.prevAtx)
        : undefined,
  ...
  toJSON(message: Activation): unknown {
    const obj: any = {};
    message.id !== undefined &&
      (obj.id = message.id ? ActivationId.toJSON(message.id) : undefined);
    ...
    message.coinbase !== undefined &&
      (obj.coinbase = message.coinbase
        ...
        : undefined);
    message.prevAtx !== undefined &&
      (obj.prevAtx = message.prevAtx
        ? ActivationId.toJSON(message.prevAtx)
        : undefined);
  ...
  fromPartial(object: DeepPartial<Activation>): Activation {
    ...
    message.id =
      object.id !== undefined && object.id !== null
        ? ActivationId.fromPartial(object.id)
        : undefined;
    message.layer =
    ...
    message.coinbase =
      object.coinbase !== undefined && object.coinbase !== null
        ...
        : undefined;
    message.prevAtx =
      object.prevAtx !== undefined && object.prevAtx !== null
...
export const Transaction = {
  encode(
    ...
    if (message.coinTransfer !== undefined) {
      CoinTransferTransaction.encode(
        message.coinTransfer,
        writer.uint32(18).fork()
      ).ldelim();
    }
    if (message.smartContract !== undefined) {
      SmartContractTransaction.encode(
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break;
        case 2:
          message.coinTransfer = CoinTransferTransaction.decode(
            reader,
            reader.uint32()
          );
          break;
        case 3:
          message.smartContract = SmartContractTransaction.decode(
            reader,
            reader.uint32()
          );
          break;
  ...
  fromJSON(object: any): Transaction {
    return {
      ...
      coinTransfer: isSet(object.coinTransfer)
        ? CoinTransferTransaction.fromJSON(object.coinTransfer)
        : undefined,
      smartContract: isSet(object.smartContract)
        ? SmartContractTransaction.fromJSON(object.smartContract)
        : undefined,
      sender: isSet(object.sender)
        ? AccountId.fromJSON(object.sender)
        : undefined,
      gasOffered: isSet(object.gasOffered)
        ? GasOffered.fromJSON(object.gasOffered)
        : undefined,
  ...
  toJSON(message: Transaction): unknown {
    ...
    message.coinTransfer !== undefined &&
      (obj.coinTransfer = message.coinTransfer
        ? CoinTransferTransaction.toJSON(message.coinTransfer)
        : undefined);
    message.smartContract !== undefined &&
      (obj.smartContract = message.smartContract
        ? SmartContractTransaction.toJSON(message.smartContract)
        : undefined);
    message.sender !== undefined &&
      (obj.sender = message.sender
        ? AccountId.toJSON(message.sender)
        : undefined);
    message.gasOffered !== undefined &&
      (obj.gasOffered = message.gasOffered
        ? GasOffered.toJSON(message.gasOffered)
        : undefined);
  ...
  fromJSON(object: any): MeshTransaction {
    return {
      ...
      layerId: isSet(object.layerId)
        ? LayerNumber.fromJSON(object.layerId)
        : undefined,
    };
  },
  ...
  toJSON(message: MeshTransaction): unknown {
    ...
    message.layerId !== undefined &&
      (obj.layerId = message.layerId
        ? LayerNumber.toJSON(message.layerId)
        : undefined);
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<MeshTransaction>): MeshTransaction {
    ...
    message.transaction =
      object.transaction !== undefined && object.transaction !== null
        ...
        : undefined;
    message.layerId =
      object.layerId !== undefined && object.layerId !== null
...
export const Reward = {
  ...
  fromJSON(object: any): Reward {
    return {
      ...
      layerReward: isSet(object.layerReward)
        ? Amount.fromJSON(object.layerReward)
        : undefined,
      layerComputed: isSet(object.layerComputed)
        ? LayerNumber.fromJSON(object.layerComputed)
        : undefined,
      coinbase: isSet(object.coinbase)
        ? AccountId.fromJSON(object.coinbase)
        : undefined,
      smesher: isSet(object.smesher)
        ? SmesherId.fromJSON(object.smesher)
        : undefined,
    };
  },
  ...
  toJSON(message: Reward): unknown {
    ...
    message.total !== undefined &&
      (obj.total = message.total ? Amount.toJSON(message.total) : undefined);
    message.layerReward !== undefined &&
      (obj.layerReward = message.layerReward
        ? Amount.toJSON(message.layerReward)
        : undefined);
    message.layerComputed !== undefined &&
      (obj.layerComputed = message.layerComputed
        ? LayerNumber.toJSON(message.layerComputed)
        : undefined);
    message.coinbase !== undefined &&
      (obj.coinbase = message.coinbase
        ? AccountId.toJSON(message.coinbase)
        : undefined);
    message.smesher !== undefined &&
      (obj.smesher = message.smesher
        ? SmesherId.toJSON(message.smesher)
        : undefined);
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<Reward>): Reward {
    ...
    message.coinbase =
      object.coinbase !== undefined && object.coinbase !== null
        ...
        : undefined;
    message.smesher =
      object.smesher !== undefined && object.smesher !== null
  ...
  fromJSON(object: any): Block {
    return {
      ...
      activationId: isSet(object.activationId)
        ? ActivationId.fromJSON(object.activationId)
        : undefined,
      smesherId: isSet(object.smesherId)
        ? SmesherId.fromJSON(object.smesherId)
        : undefined,
  ...
  toJSON(message: Block): unknown {
    ...
    message.activationId !== undefined &&
      (obj.activationId = message.activationId
        ? ActivationId.toJSON(message.activationId)
        : undefined);
    message.smesherId !== undefined &&
      (obj.smesherId = message.smesherId
        ? SmesherId.toJSON(message.smesherId)
...
export const Layer = {
  ...
  fromJSON(object: any): Layer {
    return {
      number: isSet(object.number)
        ? LayerNumber.fromJSON(object.number)
        : undefined,
      status: isSet(object.status)
        ? layer_LayerStatusFromJSON(object.status)
        : 0,
      ...
      blocks: Array.isArray(object?.blocks)
        ...
        : [],
      activations: Array.isArray(object?.activations)
        ? object.activations.map((e: any) => Activation.fromJSON(e))
        : [],
      rootStateHash: isSet(object.rootStateHash)
        ? bytesFromBase64(object.rootStateHash)
        : new Uint8Array(),
    };
  },
  ...
  toJSON(message: Layer): unknown {
    ...
    message.number !== undefined &&
      (obj.number = message.number
        ? LayerNumber.toJSON(message.number)
        : undefined);
    message.status !== undefined &&
      (obj.status = layer_LayerStatusToJSON(message.status));
    ...
    if (message.activations) {
      obj.activations = message.activations.map((e) =>
        e ? Activation.toJSON(e) : undefined
      );
    } else {
      obj.activations = [];
    }
  ...
  fromPartial(object: DeepPartial<Layer>): Layer {
    ...
    message.activations =
      object.activations?.map((e) => Activation.fromPartial(e)) || [];
