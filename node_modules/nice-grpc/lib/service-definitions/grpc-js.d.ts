...
export declare type FromGrpcJsServiceDefinition<Service extends grpc.ServiceDefinition> = {
 ...
 */
export declare type GrpcJsServiceMethodKeys<Service extends grpc.ServiceDefinition> = keyof {
    [P in keyof Service as string extends P ? never : number extends P ? never : P]: Service[P];
} & keyof Service;
export declare type FromGrpcJsMethodDefinition<Method> = Method extends grpc.MethodDefinition<infer Request, infer Response> ? MethodDefinition<Request, Request, Response, Response, Method['requestStream'], Method['responseStream']> : never;
