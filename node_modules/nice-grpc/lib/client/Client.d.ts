...
export declare type Client<Service extends CompatServiceDefinition, CallOptionsExt = {}> = RawClient<NormalizedServiceDefinition<Service>, CallOptionsExt>;
