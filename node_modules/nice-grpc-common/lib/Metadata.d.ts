...
export declare type MetadataValue<Key extends string> = string extends Key ? string | Uint8Array : Lowercase<Key> extends `${string}-bin` ? Uint8Array : string;
export declare type MetadataInit = Metadata | Iterable<[string, string | Uint8Array | Array<string | Uint8Array>]> | Record<string, string | Uint8Array | Array<string | Uint8Array>>;
export declare type MetadataConstructor = {
